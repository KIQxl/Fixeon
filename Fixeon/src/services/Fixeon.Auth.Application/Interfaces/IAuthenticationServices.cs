...
namespace Fixeon.Auth.Application.Interfaces
{
    public interface IAuthenticationServices
    {
        ...
        public Task<Response<ApplicationUserResponse>> AssociateRole(string userId, string role);
        public Task<Response<ApplicationUserResponse>> GetUserByIdAsync(string userId);
